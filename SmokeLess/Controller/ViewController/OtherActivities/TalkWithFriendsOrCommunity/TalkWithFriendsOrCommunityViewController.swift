//
//  TalkWithFriendsOrCommunityViewController.swift
//  SmokeLess
//
...
class TalkWithFriendsOrCommunityViewController: UIViewController {
...
// MARK: - Extension
extension TalkWithFriendsOrCommunityViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if (indexPath.section == 0) {
            ...
            let image = UIImage(named: "talkWithFriends")
            ...
            titleLabel.text = "Talk with Friends or Community"
            ...
            descriptionLabel.text = "Talking with your friends or sharing your story with a community can help you remember your goals and encourage each other when nicotine cravings come."
