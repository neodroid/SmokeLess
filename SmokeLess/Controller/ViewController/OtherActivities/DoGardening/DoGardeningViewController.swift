//
//  DoGardeningViewController.swift
//  SmokeLess
//
...
class DoGardeningViewController: UIViewController {
...
extension DoGardeningViewController: UITableViewDelegate, UITableViewDataSource, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if (indexPath.section == 0) {
            ...
            let image = UIImage(named: "doGardening")
            ...
            descriptionLabel.text = "Physical activities such as gardening can help you reduce stress while keeping your mind off nicotine cravings."
