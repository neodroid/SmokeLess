...
class FirstUserPlanViewController: UIPageViewController {
    ...
    override func viewDidLoad() {
        ...
        let firstLine = createMyView("bluerectangle", bgColor: UIColor.smokeLessBlue)
    ...
    func configureUI() {
        ...
        datePicker.anchor(top: titleLabel.bottomAnchor, left: view.safeAreaLayoutGuide.leftAnchor, right: view.safeAreaLayoutGuide.rightAnchor, paddingTop: 0, paddingLeft: 50, paddingRight: 50)
